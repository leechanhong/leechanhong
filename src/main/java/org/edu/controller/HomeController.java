...
public class HomeController {
	...
	public String contact_send() {
		//데이터 전송후에 페이지이동이 필요합니다. 새로고침=자동등록을 방지하기 위해서.(게시판테러방지용)
	...
	public String index() { //메서드(함수)구성: 리턴(반환값출력)형태지정 메서드명(매개변수) {구현내용} String index(){}
		...
		//메서드명 제일 앞에 있는 public는 접근권한에 대한 키워드인데요, public(공공-다른 클래스에서 접근가능)
	...
	public String home(Locale locale, Model model) {
		logger.info("개발자들이 변수값 확인용으로 사용하는 것이 로그다. 환영합니다. 현재 여러분 컴퓨터언어는 {} 입니다.", locale);
		logger.info("환영합니다. 현재 여러분의 컴퓨터언어는 " + locale + " 입니다..");
		...
		Date date = new Date();//Data 날짜관련 클래스형 변수 date 선언했습니다. date변수 메서드를 사용 가능하게 됩니다.
