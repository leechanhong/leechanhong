...
<%-- 자바주석 시작 하이픈(-)
- jsp에서  자바프로그램을 사용할 때 쓰는 태그 <% %> 감싸주게 됩니다.
...
- HTML에서는 /resources/sample/index.html 이렇게 접근합니다.
- jsp프로그램에서는 위html처럼 바로접근 못하고, 홈 컨트롤러자바를 거쳐서 index.jsp를 접근하는 이유는 보안때문입니다.
- 그래서 은행, 관공서, 대학에서 대부분 사용합니다.(스프링을 배우는 목적)
- 다른 예로, php는 위에 있는 html처럼 파일에 바로 접근이 가능합니다.(그래서, 중소기업홈페이지에서 사용)
</body>
</html>